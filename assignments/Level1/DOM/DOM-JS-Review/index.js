...
var orderedList = document.getElementsByClassName("list-items");
var unorderedList = document.querySelector(".navbar");
var headerID = document.getElementById("header1");
var header2 = document.querySelector("#header2");

headerID.style.textAlign = "center";
header2.style.color = "coral";
header2.classList.add("floating");
...
for (var i =0; i < length; i++) {
    console.log(orderedList[i].textContent);

    unorderedList.innerHTML += "<li>" + orderedList[i].textContent + "</li>";
    orderedList[i].textContent = "REDACTED";
    orderedList[i].classList.add("red");
}